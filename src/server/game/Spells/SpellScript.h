...
class SpellScript : public _SpellScript
{
    ...
    public:
        ...
        void _InitHit();
        bool _IsEffectPrevented(const SpellEffectEntry* effect) { return m_hitPreventEffectMask & (1<<effect->EffectIndex); }
        bool _IsDefaultEffectPrevented(const SpellEffectEntry* effect) { return m_hitPreventDefaultEffectMask & (1<<effect->EffectIndex); }
